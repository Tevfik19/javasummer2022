    ...
    public static void main(String[] args) {
       ...
       CLASSIN BASINDAN itibaren kod incelenmelidir.
        ...
        System.out.println("obj1'in sayi degeri : " + obj1.sayi); // 10
                           // yazdirirkende obj1. dememize gerek yok ekranin sari olasida bu yuzden obj.kullanmana gerek yok diyor
        obj1.rakam+=1; // 5+1=6
        obj1.sayi+=1; // 10+1=11  (burda obj1. demesekte calisir cunku sayi static tir class in her yerinden calisir
