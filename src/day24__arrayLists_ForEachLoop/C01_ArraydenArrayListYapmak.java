...
public class C01_ArraydenArrayListYapmak {
    ...
    public static void main(String[] args) {
        ...
        // 1.yan etki(asList le yapilan listeye ekleme silme yaptigimizda exception verdi)
