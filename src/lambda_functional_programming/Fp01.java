...
public class Fp01 {
    ...
    public static void main(String[] args) {
        ...
        getMinumumEleman01(liste);
        getMinumumEleman02(liste);
    ...
    public static void tekrarsizTekElemanlarinKupunuYazdir(List<Integer> list) {
        ...
        //distinct() tekrarli olan elemanlari almamamak icin kullanilir
   ...
   //reduce() methodu tek deger oldugu icin bir variable atama yaptık yazdiradabiliriz   t ilk deger u ikini deger olur
    ...
    public static void getMinumumEleman01(List<Integer>list){
    ...
    public static void getMinumumEleman02(List<Integer>list){

        Integer min =list.stream().distinct().sorted(Comparator.reverseOrder()).reduce(list.get(0),(t,u)->u );
        System.out.println("min01 :"+min);
    }
    ...
    public static void getYedidenBuyukCiftMin2(List<Integer> list){
        ...
        Integer min = list.
                ...
                filter(t->t%2==0).
                filter(t->t>7).
                sorted(Comparator.reverseOrder()).  // Comparator.reverseOrder() terten buyukten kucuge siralar
    ...
    public static void getYedidenBuyukCiftMin3(List<Integer> list) {
        ...
        Integer min = list.
                ...
                filter(t -> t > 7).
                sorted().
                findFirst().// birinciyi bul methodu ama sonuna get() methodu koymaliyiz
                get();
