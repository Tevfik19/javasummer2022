...
public class Fp02 {
    ...
    */
    public static void main(String[] args) {
        ...
        tekrarsızCiftElemanlarınKüpününCarpımı(liste);
    ...
    public static void listElemanlariniYazdirFunctional(List<Integer> list){
     ...
     //   list.stream().forEach(t-> System.out.print(t+" "));
       ...
       // list.stream().forEach(System.out::print); //  "Method Reference" ile yaptik parantez yok oncesinde iki tane cift nokta var

        //  Aralara bosluk koymak icin kendimiz method olusturduk utils class inda simdi onunla kullanacagiz

        list.stream().forEach(Utils::ayniSatirdaBosluklaYazdir); // class ismi sonra iki cift nokta sonra  parantezsiz method
   ...
   // 2.yol
    ...
    public static void tekrarsizCiftElemanlarinKareToplami03(List<Integer>list) {
        ...
        // Integer da sum da toplamayi verir
    ...
    //Ödev
    //8)List elemanları arasından en küçük değeri bulan bir method oluşturun.(Method Referance)
   ...
   //  filter(Utils::yedidenBuyuk) her zaman kullanmayacagimiz icin method a gerek yok
    ...
    public static void tersSiralamaylaTekrarsizElemanlarinYarisi(List<Integer> list){
        ...
        System.out.println("sonuc 10=  " + sonuc);
    }
