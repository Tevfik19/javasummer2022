...
public class Isci extends Personel{
    ...
    public static void main(String[] args) {
        ...
        isci1.maas();// Tum personelin maasi vardir kendinde bu method olmadigindan parent a gidip aldi

        //  simdi bu class a da bir maas methodu korsak


          // asagidaki methodu olusturunca artik personel e yani parent class ina gitmez yukarda
         // Isciler minumum 15 euro saat ucreti alir yazar
    }
