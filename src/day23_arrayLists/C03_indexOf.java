...
public class C03_indexOf {
    public static void main(String[] args) {
        ...
        System.out.println(urunler.indexOf("Ikram"));//1 ikram in bulundugu index i dondurdu
        System.out.println(urunler);// [Nutella, Ikram, Cekirdek, Cay]
        ...
        System.out.println(urunler.indexOf("Ikram"));// 1 (bastaki ikramin index ini dondurdu)
        System.out.println(urunler.lastIndexOf("Ikram"));// 4  (bastaki ikramin index ini dondurdu)
