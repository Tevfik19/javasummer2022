...
public class C03_Contains {
    public static void main(String[] args) {
        ...
        boolean sonuc= contains(isimler,arananIsim);// sonuc donduren dedigi icin atama yaptik

        if (sonuc){ // sonuc direk true dondurecegi icin bir seye esitlemeye gerek yok
   ...
   public static boolean contains(String[] isimler, String arananIsim) {
        ...
        for (int i = 0; i < isimler.length ; i++) {
            if (isimler[i].equalsIgnoreCase(arananIsim)){ // ıgnorcase kullanmamizin sebebi
                                                        // kullanici kucuk buyuk girsede kabul etsin
                sonucMethod=true;
            }
        }
